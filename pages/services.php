...
<div class="row">
	...
	<div class="sixcol">
		...
		<p>WordPress is used on over 60 million websites, including almost 20% of the world’s top sites, and with good reason: it's flexible, expandable, and easy-to-use! I build most of my websites using Wordpress. This means you'll be able to update your website as easily as your Facebook status. I customize the site to your particular needs and make sure it's as simple as possible for you to edit and update.</p>
		...
		<p>Great interfaces mean that people feel happy using your product. I design beautiful, usable interfaces for web and mobile apps, taking into consideration user needs.</p>
	...
	<div class="sixcol last">
		...
		<p>First impressions <em>do</em> count. People <em>do</em> judge a book by its cover. The first thing your customers see of you is your logo. What is it telling them? One you've got a logo, you need a business card, letterhead, and maybe a whole range of other materials. I can make sure your look is consistent throughout, so everything just fits right.</p>
	
		<h3>Printed promotions</h3> 
		<p>Brochures, advertisements, mailouts, stickers, t-shirts, flyers, postcards, newsletters, packaging—don't just put your logo on it, make it look lovely to boot. If you can print it out, or show it on a screen, I can make it eye-catching and gorgeous.</p>
