...
<div class="row">
	...
	<p>After evaluating her precise needs from an administrative point of view, I suggested a few options for online gift certificates, set up a simple form for booking an appointment, and created a custom WordPress installation. Promotions are managed as a special post type, allowing for easy entry without replicating the same content.</p>
	
	<p>Simple isn't always as easy as it seems. A particular challenge inherent in this site was developing style rules that would work across a variety of different pages. Many of the pages are structured as price lists, and I played around with the rules quite a few times before settling on a set of rules that worked consistently and displayed well across all pages. The resulting lists are both aesthetically appealing and easily scanned.</p>
